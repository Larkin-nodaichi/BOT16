...
if uploaded_file is not None:
    try:
        ...
        # Ensure required 'Rain' column exists
        if 'Rain' not in df.columns:
            st.error("Error: The uploaded dataset must contain a 'Rain' column.")
            st.stop()
        ...
        try:
            ...
            st.error("Error: Model files not found. Train the model and save as 'best_model.joblib' and 'scaler.joblib'")
            st.stop()
